...
> - Nếu đã cài build tool nhưng vẫn gặp lỗi khi cài đặt thư viện thì bạn có thể sử dụng phiên bản đã cài sẵn thư viện (lưu ý phiên bản này không cần chạy câu lệnh cài đặt phía trên, tải về giải nén sau đó thiết lập data để chạy) [[Link Tải]](https://disk.yandex.com/d/8Ji4Bamkt-uIHQ)
